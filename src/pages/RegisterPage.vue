    ...
    <main class="auth-wrapper">
        <form class="auth-form" @submit.prevent="handleSubmit">
            ...
            <div class="form-floating mb-2">
                <input type="test" class="form-control" :class="{'is-invalid':errors.name && errors.name[0]}" v-model="form.name" id="name" placeholder="Your name" />
            ...
            <div class="form-floating mb-3">
                <input type="password" class="form-control" :class="{'is-invalid':errors.password && errors.password[0]}" v-model="form.password" id="password" placeholder="Password" />
